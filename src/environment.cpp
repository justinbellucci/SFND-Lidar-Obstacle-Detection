...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI>* pointProcessorI, const pcl::PointCloud<pcl::PointXYZI>::Ptr& inputCloud)
{
    ...
    std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClustersI = pointProcessorI->ClusteringCustom(segmentedCloudI.first, 0.6, 15, 1000); 
    ...
    for(pcl::PointCloud<pcl::PointXYZI>::Ptr clusterI : cloudClustersI)
    {
        ...
        renderBox(viewer, box, clusterID, Color(1,1,1), 0.3);
        ++clusterID;
    }
}   
